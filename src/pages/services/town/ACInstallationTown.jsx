...
const ACInstallationTown = ({ townKey }) => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: `We install all major brands, including Carrier, Trane, Lennox, Goodman, and Rheem. We help you choose the right efficiency and features for your home and budget, and we never push a bigger system than you need.`
    },
    {
      question: `How long does a new AC installation take in ${t.name}?`,
      answer: `Most straightforward residential system swaps are completed in a single day. Larger or multi-zone jobs, or ones that involve ductwork changes, can take longer, and we will give you a clear timeline with your estimate before any work starts.`
    },
    {
      question: `Do you offer financing on a new AC in ${t.name}?`,
      answer: `Yes. We offer financing through Synchrony and FTL Finance, with options for a range of credit situations, so a new system fits your monthly budget. We review the plans with you during your free estimate.`
    },
    {
      question: `Will a new high-efficiency system lower my energy bills in ${t.name}?`,
      answer: `A properly sized, high-efficiency SEER2 system typically uses noticeably less energy than an older unit, especially through the long ${t.name} cooling season. The exact savings depend on your home and how the old system was running, and we will give you an honest estimate.`
    }
  ];
          ...
          <div className="max-w-5xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
              <div className="bg-white rounded-xl p-5 text-center">
                ...
                <p className="text-gray-600 text-xs mt-1">We measure the home and run a load calculation for the right size</p>
              </div>
              <div className="bg-white rounded-xl p-5 text-center">
              ...
              <div className="bg-white rounded-xl p-5 text-center">
                ...
                <p className="text-gray-600 text-xs mt-1">Licensed technicians set the equipment, ducts, and controls correctly</p>
              </div>
              <div className="bg-white rounded-xl p-5 text-center">
                ...
                <p className="text-gray-600 text-xs mt-1">We confirm airflow, refrigerant charge, and comfort before we leave</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 bg-white">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <p className="text-gray-700 mb-6 leading-relaxed text-base md:text-lg">
              ...
              equipment. We give you a straight assessment for your {t.name} home and never push a replacement on a system
              that has good years left. When a repair makes more sense, we will tell you and point you to our
        ...
        <section className="py-12 bg-gray-50">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-8">
              ...
              <div className="bg-white rounded-lg p-4 shadow-sm flex items-start gap-3">
                <span className="text-green-500 font-bold text-lg mt-0.5">&#10003;</span>
                <span className="text-gray-700 text-base font-medium">Proper load-calculated sizing</span>
              </div>
              <div className="bg-white rounded-lg p-4 shadow-sm flex items-start gap-3">
                <span className="text-green-500 font-bold text-lg mt-0.5">&#10003;</span>
