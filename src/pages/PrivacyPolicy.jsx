        ...
        <section className="bg-blue-900 py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a
                href="tel:+19363311339" onClick={() => trackPhoneClick('privacy_policy_page')}
          ...
          <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="mb-10 bg-blue-50 border-l-4 border-blue-600 rounded-lg p-6">
              ...
              <ul className="text-base md:text-lg text-gray-700 space-y-1">
                ...
                <li>Phone: <a href="tel:+19363311339" onClick={() => trackPhoneClick('privacy_policy_page')} className="text-blue-600 hover:text-blue-800 transition">(936) 331-1339</a></li>
