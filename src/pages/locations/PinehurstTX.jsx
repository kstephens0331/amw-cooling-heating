  ...
  return (
    <>
      ...
      <main className="bg-white text-gray-800 font-sans">
        ...
        <section className="bg-blue-900 py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a
                href="tel:+19363311339" onClick={() => trackPhoneClick('location_pinehurst-tx_page')}
        ...
        {/* FAQ Section */}
        <LocationFAQ town={LOCATION_FAQS['pinehurst-tx'].town} faqs={LOCATION_FAQS['pinehurst-tx'].faqs} />
